...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZ3JhYmJhNDUiLCJhIjoiY2t4eHVhM3B3YTVhcTMxcTNxcmgxeWF6ZCJ9.FqRQa75YHjN1goas6p_o_A';
  var map = new mapboxgl.Map({
    // the container for the map needs an element to be nested in => hence => map id created in tour pug file
    container: 'map',
    // container ID
    style: 'mapbox://styles/grabba45/ckxxvfz1v165w14phfkavee53',
    // style URL
  ...
  locations.forEach(function (location) {
    ...
    element.className = 'marker'; // Creates a marker and set the exact anchor location =>
    ...
    new mapboxgl.Marker({
      ...
      anchor: 'bottom'
    }).setLngLat(location.coordinates).addTo(map); // Include a popup

    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(location.coordinates).setHTML("<p>Day ".concat(location.day, ": ").concat(location.description, "</p>")).addTo(map); // Extend the the map bounds to include the location of the current tour
...
var showAlert = function showAlert(type, message) {
  ...
  document.querySelector('body').insertAdjacentHTML('afterbegin', markup); // Close Alert
...
var stripe = Stripe('pk_test_51JvqF4EQ1brAT2zcygAQXB8s5Lke8hIg3mJflOuFvDpmN6njiZIA6Kxg7h0tlQHCNQP2wwxQmk3IDKmVIkGoux1q00b2bzJGRd');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            url = type === 'password' ? '/api/v1/users/updateMyPassword' : '/api/v1/users/updateMe'; // 1. send request to backend to update user information
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)(res.data.status, 'Updated User Information Successfully!');
            }
          ...
          case 8:
            ...
            message = _context.t0.response.data.message; // alert the error message
...
var loginUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(email, password) {
    var res, _error$response$data, message, status;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)(res.data.status, 'Logged In Successfully'); // reload page after successful sign in
          ...
          case 7:
            ...
            _context.t0 = _context["catch"](0);
            console.error(_context.t0.response.data);
            _error$response$data = _context.t0.response.data, message = _error$response$data.message, status = _error$response$data.status; // alert the error message
...
var logoutUser = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var res, _error$response$data2, message, status;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            _error$response$data2 = _context2.t0.response.data, message = _error$response$data2.message, status = _error$response$data2.status; // alert the error message
...
var _require = require('./login'),
    ...
    logoutUser = _require.logoutUser; // DOM Elements
...
if (loginForm) {
  ...
  loginForm.addEventListener('submit', function (event) {
    // 1. prevent default
    event.preventDefault(); // 2. extract user email and password

    var email = document.getElementById('email').value;
    var password = document.getElementById('password').value; // 3. send a request to login the user
...
if (updateUserForm) {
  updateUserForm.addEventListener('submit', function (event) {
    event.preventDefault(); // 1. Create form data to update current user
    ...
    form.append('photo', document.getElementById('photo').files[0]); // 2. send request to the backend to update user information

    (0, _updateSettings.updateUserInfo)(form, 'data');
  });
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              document.querySelector('.btn--save-password').textContent = 'updating..'; // 1. extract the password fields

              passwordCurrent = document.getElementById('password-current').value;
              password = document.getElementById('password').value;
              passwordConfirm = document.getElementById('password-confirm').value; // 2. send request to update password

              _context.next = 7;
              return (0, _updateSettings.updateUserInfo)({
            ...
            case 7:
              ...
              document.getElementById('password-current').value = document.getElementById('password').value = document.getElementById('password-confirm').value = null;
